...
{
    $url = 'http://localhost/fantacalcio-app/backend/api/rosa/addPlayerToSquad.php';
...
{
    $url = 'http://localhost/fantacalcio-app/backend/api/rosa/getNumberPlayer.php?id_squad=' . $id_squad;
